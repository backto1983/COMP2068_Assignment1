...
exports.projects = (req, res, next) => {
  const project1 =
    "This application is a demo site for a school assignment that uses Entity Framework. It is a ASP.NET MVC Web Application which integrates a SQL Server database to perform CRUD operations.";
  const projectTitle1 = "Bookstore Website";
  const project2 =
    "This is a demo application for a school assignment. It has login functionality, database integration, and uses charts and tables to show information.";
  const projectTitle2 = "Bookstore Java App";
  const project3 =
    "This is a project for a school assignment. It shows steps to create a Project Plan, which includes a Work Breakdown Structure, a Gantt Chart, a Risk Management Plan and more.";
